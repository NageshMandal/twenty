...
export const connectionRequestVariables = [
  ...
  {
    value: '#on_1_business_days_from_now',
    label: 'On 1 business days from now',
  },
  {
    value: '#on_2_business_days_from_now',
    label: 'On 2 business days from now',
  },
  {
    value: '#on_3_business_days_from_now',
    label: 'On 3 business days from now',
  },
  {
    value: '#on_4_business_days_from_now',
    label: 'On 4 business days from now',
  },
  {
    value: '#on_5_business_days_from_now',
    label: 'On 5 business days from now',
  },
