...
const blocks: TBlock[] = [
  { icon: '', description: 'From Scratch', value: 4 },
  { icon: '', description: 'From Template', value: 5 },
  { icon: '', description: 'From my Leads', value: 1 },
  // { icon: "Visitor", description: "From Website Visitor", value: 2 },
  { icon: '', description: 'From LinkedIn Search or List', value: 3 },
  { icon: '', description: 'From Linkedin Post Commenters', value: 7 },
  { icon: '', description: 'From Linkedin Post Likes', value: 8 },
  { icon: '', description: 'From Website Visitor', value: 6 },
];
