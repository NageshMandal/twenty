...
export interface IAiSdrRequest {
  wid: string;
  pid?: number;
  sid?: number;
  cid?: number;
...
export interface IOrganizationPrompts {
  [key: string]: IAskAiPrompt[];
}
