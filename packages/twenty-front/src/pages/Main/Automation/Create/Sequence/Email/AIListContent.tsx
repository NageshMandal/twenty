...
const AIListContent: React.FC<AIListContentProps> = ({
  templates,
  onSelect,
  selectedTemplate,
  onMgptPromptSave,
        ...
        <div className="w-1/2 pl-10">
          <div>
            ...
            <div className="relative p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
              ...
              <div className="text-md text-gray-600 dark:text-gray-300 pb-8">
                Example:
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-300 pb-8">
                {selectedTemplate.example}
            ...
            <p className="text-sm text-green-600 dark:text-green-300 pb-4">
              (Choose language the AI model writes (make sure to use language
              filters on LinkedIn to sort by profile language, for better reply
              rate)
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-300 pb-4">
              (If we have insufficient data such as Missing Post, About, Company
              Info etc the model will return a default AI generated request)
            </p>
            <div className="pt-8">
              <Button
                prefix="MessageBox"
