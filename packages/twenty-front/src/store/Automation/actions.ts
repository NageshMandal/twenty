...
export const setValueBuilderMessage = createAction<IBuilderMessage>(
  'builder/message/show',
);

export const setResetBuilderMessage = createAction('builder/message/reset');

export const setValueBuilderAiSdr =
  createAction<IBuilderAiSdr>('builder/aisdr/show');

export const setResetBuilderAiSdr = createAction('builder/aisdr/reset');

export const setValueBuilderAiSdrSetup = createAction<IBuilderAiSdrSetup>(
  'builder/aisdrsetup/show',
);

export const setResetBuilderAiSdrSetup = createAction(
  'builder/aisdrsetup/reset',
);

export const setValueBuilderEmail =
  createAction<IBuilderEmail>('builder/email/show');
