  ...
  return (
    <div>
      <div className="flex flex-col gap-10 py-10 mt-10 items-center justify-center pt-10">
        <h2 className="text-neutral-800 dark:text-neutral-300 text-16">
          My Leads/CSV or Plugin
        </h2>
        <p className="text-neutral-700 dark:text-neutral-400 text-15">
          Start an automation from My Contacts at anytime you like, this is the
          starting point for an automation taking place from my Contacts.
        </p>
      </div>
