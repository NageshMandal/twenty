...
import AIListContent from '../../../pages/Main/Automation/Create/Sequence/Email/AIListContent';
...
const ConnectionRequestModal: React.FC<ModalProps> = ({
  show = false,
  onClose = () => {},
  disabled = false,
  className = '',
        ...
        <div className="relative z-50 dark:scrollbar-thumb-neutral-700 scrollbar-thumb-neutral-300 scrollbar-thin">
          ...
          <div className="fixed inset-0 z-50 flex items-end justify-center py-20 overflow-hidden tablet:items-center">
            <Transition.Child
              ...
              enter={'ease-out duration-300'}
              enterFrom={
                'tablet:opacity-0 tablet:scale-95 translate-y-full tablet:translate-y-0'
              }
            ...
            >
              ...
              >
                ...
                <div
                  className={classNames('h-full tablet:p-20 p-15', className)}
                >
                  {/* {children} */}
                  <AIListContent
                    templates={templates}
