...
const SequenceTab: React.FC<Props> = ({
  ...
  return (
    <div className="w-100vw relative">
        ...
        <div className="flex items-center justify-between pb-20 pt-30 max-w-100vw">
          <div className="flex items-center gap-6">
            <p className="font-normal text-neutral-800 dark:text-neutral-300 text-14">
              All leads that reply to your connection request, message or InMail
              will be put on hold, and further actions won't be performed
            </p>
      ...
      {builderMessage && builderMessage.id && (
        <Message builderMessage={builderMessage} />
      )}
