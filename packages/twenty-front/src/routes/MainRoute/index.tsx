...
const AutomationCreatePage = lazy(
  () => import('../../pages/Main/Automation/Create/index.tsx'),
);
...
const PersonalizationPage = lazy(
  () => import('../../pages/Main/1-1-Automations'),
);
const PersonalizationDetailPage = lazy(
  () => import('../../pages/Main/1-1-Automations/Detail'),
);

//Social Selling
const SettingPage = lazy(() => import('../../pages/Main/Setting'));
const SocialSellingPage = lazy(
  () => import('../../pages/Main/SocialSelling/Index'),
);
...
//Integration
const IntegrationIndexPage = lazy(
  () => import('../../pages/Main/Integration/Index'),
);
const IntegrationDetailPage = lazy(
  () => import('../../pages/Main/Integration/Detail'),
);

const SalesAutomationDetailPage = lazy(
  () => import('../../pages/Main/SocialSelling/Detail'),
);
    ...
    <MainLayout>
      <Suspense fallback={<div>Loading...</div>}>
        <Routes>
          ...
          <Route
            path="/1-1-automation/:wid"
            element={<PersonalizationDetailPage />}
          />

          <Route path="/social-selling" element={<SocialSellingPage />} />
          <Route
            path="/social-selling/:wid"
            element={<SalesAutomationDetailPage />}
          />
          ...
          <Route
            path={paths.main.integration.detail}
